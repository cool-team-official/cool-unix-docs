...
export default defineConfig({
	...
	themeConfig: {
		...
		editLink: {
			text: "在GitHub上编辑",
			pattern: "https://github.com/cool-team-official/cool-uni-docs/blob/main/:path"
		},
		// https://vitepress.dev/reference/default-theme-config
		nav: [
			{ text: "介绍", link: "/src/introduce/index.md", noIcon: false },
			{ text: "版本 8.1.0", link: "/src/todo/update.md", noIcon: false },
		...
		sidebar: [
			...
			},
			{
				items: [
					...
					{
						text: "插件市场引入",
						link: "/src/introduce/uni-components.md"
					},
			...
			},
			{
				items: [
					{
						text: "插件开发",
						link: "/src/guide/plugins.md"
					},
					{
						text: "@cool-vue/unix",
						link: "/src/packages/unix.md"
					},
					{
						text: "@cool-vue/unix-cli",
						link: "/src/packages/unix-cli.md"
					}
				]
			},
			{
				...
				items: [
					...
					},
					{
						...
						items: [
							...
							{
								text: "Tabbar 底部导航栏",
								link: "/src/components/layout/tabbar.md"
							}
						]
					},
					{
					...
					},
					{
						...
						items: [
							...
							{
								text: "Watermark 水印",
								link: "/src/components/other/watermark.md"
							},
							{
								text: "Cropper 图片裁剪",
				...
				items: [
					{
						...
						items: [
							...
							{ text: "plugins", link: "/src/guide/plugins.md" },
							{ text: "static", link: "/src/guide/static.md" },
							{
								...
								items: [
									...
									{
										text: "cool-share",
										link: "/src/guide/uni-modules/cool-share.md"
									},
									{
										text: "cool-svg",
										link: "/src/components/other/svg.md"
